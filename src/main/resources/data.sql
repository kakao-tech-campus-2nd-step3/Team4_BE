...
VALUES ('a@naver.com', '123', '일반회원1', 'https://nurspace-bucket.s3.ap-northeast-2.amazonaws.com/default_profile.jpg',
        '강원특별자치도 춘천시 백령로 1');

INSERT INTO TRAINER_TB(email, password, name, profile_image_url, gym_id, gender)
VALUES ('t@naver.com', '123', '트레이너1', 'https://nurspace-bucket.s3.ap-northeast-2.amazonaws.com/default_profile.jpg', 1,
        'MALE');
